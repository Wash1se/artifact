...
type LiquidButtonProps = ComponentProps<"button"> & {
  size?: "xxl";
};
...
export function LiquidButton({
  ...
  return (
    <button
      className={`relative inline-flex h-14 shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md bg-transparent px-10 text-sm font-medium text-primary transition duration-300 hover:scale-105 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 ${className}`}
      {...props}
    >
